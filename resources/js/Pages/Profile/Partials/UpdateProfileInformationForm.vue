...
<template>
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            <Row>
                <Input required classInput="h-10" placeholder="Nome" label="Nome " v-model="form.name" />
            </Row>

            <Row>
                <Input required classInput="h-10" placeholder="Email" label="Email" v-model="form.email" />
            </Row>
